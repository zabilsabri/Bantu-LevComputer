...
<div class="footer-top">
    ...
    <div class="row">
        ...
        <h4>Our Services</h4>
        <ul>
            <li><i class="bx bx-chevron-right"></i> <a href="#">Services Laptop</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="#">Services PC</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="#">Services Handphone</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="#">Services PS4</a></li>
        </ul>
        </div>
